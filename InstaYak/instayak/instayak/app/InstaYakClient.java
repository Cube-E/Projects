...
public class InstaYakClient {
	...
	public static void main(String[] args) {
		...
		if ((args.length != 4)) {
			System.err.println(UNABLE_TO_COM + "Parameter(s): <Server><Port><UserID><Password>");
			System.exit(-1);
		}
	...
	private static void sendUOn(MessageOutput out, Scanner sin) throws IOException, InstaYakException {
		...
		while ((category == null || category.isEmpty() || !hasAlphNumeric(category))) {

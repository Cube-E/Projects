...
public class InstaYakAIOHandler implements AIOHandler {
	...
	/**
	 * handles the reads for the server
	 * 
	 * @param readBuff
	 *            the buffer holding the information
	 * @param logger
	 ...
	 * @return byte[] the buffer that holds the new information
	 * @throws IllegalArgumentException
	 *             if an illegal argument is given when reading in from the
	 *             buffer
	 * @throws IllegalStateException
	 *             if an illegal state is taken
	 */
	@Override
	public byte[] handleRead(byte[] readBuff, Logger logger, final AsynchronousSocketChannel clntChan, File pFile)
	...
	private static boolean sendUOnSLMD(InstaYakMessage msg, Logger logger, String userID,
			AsynchronousSocketChannel clntSock) throws IOException, SocketException {
	...
	private static String readInstaYakID(InstaYakMessage msg, Logger logger, MessageInput in,
			final AsynchronousSocketChannel clntChan) throws InstaYakException, IOException {
